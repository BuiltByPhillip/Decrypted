...
export default function ProgressBar({ results, total, currentIndex, onSegmentClick }: ProgressBarProps) {
        ...
        <div className="relative w-5 h-150">
            ...
            <div
                ...
                style={{
                    ...
                    borderLeft: "10px solid rgba(156,163,175,0.5)",
                }}
            />
            {/* Segments — kept in own div to preserve rounding and clipping */}
            <div className="flex flex-col w-full h-full rounded-full overflow-hidden divide-y divide-black/30">
